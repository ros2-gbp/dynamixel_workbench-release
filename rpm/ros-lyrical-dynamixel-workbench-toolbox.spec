...
%global pkg_name dynamixel_workbench_toolbox
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-dynamixel-workbench-toolbox
Version:        2.2.5
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 Pyo <pyo@robotis.com> - 2.2.5-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Pyo <pyo@robotis.com> - 2.2.5-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Pyo <pyo@robotis.com> - 2.2.5-1
- Autogenerated by Bloom
